...
const {createPost,likePost,unlikePost,deletePost,addComment,getPostById,getAllUserPosts} = require('../controllers/postController')
...
Router.get('/all_posts',auth,getAllUserPosts)
